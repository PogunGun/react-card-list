...
import
AddShoppingCartOutlinedIcon from '@mui/icons-material/AddShoppingCartOutlined';
    ...
    <section className='full-width m-auto'>
      <div className='mt-50'>
        <div>
          ...
          <Typography paragraph>
            ...
            Eligendi exercitationem facere ipsa
                        necessitatibus optio qui similique soluta veritatis.
                        Architecto aspernatur
                        delectus enim iste
                        laboriosam laudantium maiores
            <Link href="#" underline="hover">necessitatibus </Link> nobis
      ...
      <Grid container spacing={5} className={style.centerGrid}>
        <Grid item xs={12} sm={6} md={3}
          ...
          <p> Lorem ipsum
            <Link href="#" underline="hover">dolor</Link>
        ...
        >
          <AddShoppingCartOutlinedIcon
            ...
            className='mr-10'
          />
          <p>Lorem ipsum dolor sit <Link href="#" underline="hover">amet
          </Link> , consectetur adipisicing
                        elit</p>
        </Grid>
      </Grid>
    </section>
